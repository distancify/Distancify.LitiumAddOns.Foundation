...
namespace Distancify.LitiumAddOns.ProductMedia.Mapping
{
    public class MediaMapper : IMediaMapper
    {
        ...
        private readonly IList<IFieldSetter<File>> _fieldSetters;
        ...
        public MediaMapper(BaseProductService baseProductService,
            ...
            IEnumerable<IFieldSetter<File>> fieldSetters) : this(
                baseProductService,
                variantService,
                ...
                mediaProfiler,
                fieldSetters,
                ConfigurationManager.AppSettings["LitiumProductMediaUploadFolder"]
            )
        { }
        ...
        public MediaMapper(BaseProductService baseProductService,
            ...
            IMediaArchive mediaArchive,
            IMediaProfiler mediaProfiler,            
            IEnumerable<IFieldSetter<File>> fieldSetters,
        ...
        {
            var targetFolder = _mediaArchive.GetFolder(string.Format("{0}/{1}", _targetFolder, media.ArchivePath), true);
            _mediaArchive.MoveFile(media.File.SystemId, targetFolder);
        }

        private IEnumerable<MediaProfile> GetProfiledMediaFromTargetFolder()
        {
            var targetFolder = _mediaArchive.GetFolder(_targetFolder, true);
